export const m = {
  ...
  System_Config: '시스템설정',
  Judge_Server: '채점서버',
  Prune_Test_Case: '평가목록정리',
  Problem: '문제',
  FromFile: '파일 가저오기',
  ToFile: '파일 내보내기',
  ShareSubmission: '제출공유',
  Problem_List: '문제목록',
  Create_Problem: '문제생성',
  Export_Import_Problem: '문제 내보내기/불러오기',
  Contest: '대회',
  Contest_List: '대회목록',
  Create_Contest: '대회만들기',
  // User.vue
  User_User: '사용자',
  ...
  IP: '아이피',
  Judger_Version: '채점 버전',
  Service_URL: '서비스 URL',
  Last_Heartbeat: '최근 Heartbeat',
  Create_Time: '시간 생성',
  // PruneTestCase
  Test_Case_Prune_Test_Case: '채점 케이스 정리',
  // Problem.vue
  Display_ID: '번호',
  Title: '제목',
  Description: '설명',
  Input_Description: '입력 예시',
  Output_Description: '출력 예시',
  Time_Limit: '시간 제한',
  Memory_limit: '메모리 제한',
  Difficulty: '난이도',
  Visible: '보기',
